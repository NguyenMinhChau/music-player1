...
const PLAYER_KEY = 'My Music - Music player';
...
const app = {
    isRepeat: false, // XỬ DỤNG VỚI NHỮNG THẰNG 1 KHUNG CHỨA NHƯNG CHỨA 2 SỰ KIỆN
    isRandom: false,
    isPlaying: false,
    currentIndex: 0,

    /* DÙNG ĐỂ LƯU TRẠNG THÁI CÁC OPTION MÀ DEVELOPER MUỐN LƯU VÀO localStorage của thiết bị người dùng 
        Ví dụ: Khi người dùng bấm nút loop -> thoát ứng dụng -> mở lên lại thì nút loop vẫn đang active
    */
    ...
    songs: [
        ...
        },
        {
            ...
            name: 'Rồi Tới Luôn',
            singer: 'Nal',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOZWCUC/320'
        },
        {
            ...
            name: 'Sai Cách Yêu',
            singer: 'Lê Bảo Bình',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOZE7EZ/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUECEIC/320'
        },
        {
            ...
            name: 'Em Hát Ai Nghe',
            singer: 'Orange',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU8FEI8/320'
        },
        {
            ...
            name: 'Em Hứa Thế Nào',
            singer: 'Như Việt, ACV',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOF9D6O/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOI0CDI/320'
        },
        {
            ...
            name: 'Chiều Đồng Quê',
            singer: 'H2K',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOFC78E/320'
        },
        {
            ...
            name: 'Thú Tội',
            singer: 'Đạt G',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUA8I89/320'
        },
        {
            ...
            singer: 'Hoài Lâm',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZUD6WA/320'
        },
        {
            ...
            singer: 'MONSTAR',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW9EB6F/320'
        },
        {
            ...
            name: 'Sầu Tương Tư',
            singer: 'Nhật Phong',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUIZZ800/320'
        },
        {
            ...
            singer: 'Lee Ken, Nal',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOAFI9D9/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0C7D9C/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU9I9F6/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0E8DO0/320'
        },
        {
            ...
            singer: 'Chi Dân',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU8DOIF/320'
        },
        {
            ...
            singer: 'Mr. Siro',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWEDZ80/320'
        },
        {
            ...
            name: 'Anh Thề Đấy',
            singer: 'Thanh Hưng',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOFBAAWC/320'
        },
        {
            ...
            singer: 'Lee Ken, Nal',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW7IZ6O/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUF9EC6/320'
        },
        {
            ...
            singer: 'DatKaa, Kido',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOAFBWB0/320'
        },
        {
            ...
            name: 'Thương Thầm',
            singer: 'NB3 Hoài Bảo',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0WU9EF/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOFA609Z/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUUEEIE/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOEOIZO/320'
        },
        {
            ...
            name: 'Khoan Thai',
            singer: 'Khải Đăng',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUFAAOE/320'
        },
        {
            ...
            name: 'Hoàng Hoa Ký',
            singer: 'Long Nón Lá',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW9F7FO/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUFAZFE/320'
        },
        {
            ...
            name: 'Lỗi Tại Anh',
            singer: 'Alex Lam',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUIA8606/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWEADBF/320'
        },
        {
            ...
            singer: 'H2K, Kunzing',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW8F7EB/320'
        },
        {
            ...
            singer: 'Đạt G',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZZ8OFW/320'
        },
        {
            ...
            singer: 'Lâm Bảo Ngọc',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUO966EE/320'
        },
        {
            ...
            singer: 'Kidz',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZOC06U/320'
        },
        {
            ...
            singer: 'Hồng Thanh',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUE0FA7/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOFEOCIO/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZUCZIW/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOEOWAZ8/320'
        },
        {
            ...
            singer: 'Huy Vạc',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZI6O7O/320'
        },
        {
            ...
            name: 'Ôm Em Lần Cuối',
            singer: 'NIT, Sing',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUABI97/320'
        },
        {
            ...
            name: 'Quý Giá',
            singer: 'Đạt G',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUE9AOC/320'
        },
        {
            ...
            singer: 'Nal',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU68U78/320'
        },
        {
            ...
            singer: 'Da LAB',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZI8OB9/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0C6UO8/320'
        },
        {
            ...
            singer: 'K-ICM, RYO',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU09FBI/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWIB0AW/320'
        },
        {
            ...
            name: 'Ngã Đau',
            singer: 'Thiên Tú',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOFAAEO/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOFZBD6F/320'
        },
        {
            ...
            singer: 'K-ICM',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZIUUWF/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUA99F8/320'
        },
        {
            ...
            singer: 'Huy Vạc',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWA00EU/320'
        },
        {
            ...
            singer: 'K-ICM',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUA8U6E/320'
        },
        {
            ...
            singer: 'Thương Võ, ACV',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0WFOIF/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUWZZ9I/320'
        },
        {
            ...
            singer: 'Võ Kiều Vân',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOFA9C8/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW6OFZA/320'
        },
        {
            ...
            singer: 'Nguyên., KOO',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUO80WOW/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW8W0ED/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUA88O9/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0DOC8F/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOZ0C0B/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZODF6BFD/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOACFBBU/320'
        },
        {
            ...
            singer: 'Vicky Nhung',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZIO9UU/320'
        },
        {
            ...
            singer: 'Anh Quân Idol',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0A686B/320'
        },
        {
            ...
            name: 'Tĩnh Lặng',
            singer: 'Chi Dân',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUF9770/320'
        },
        {
            ...
            name: 'Gần Anh Hơn',
            singer: 'Đức Hati',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUDC8UB/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUI98BWF/320'
        },
        {
            ...
            singer: 'Tân Trần',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWD7BDC/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUZIO090/320'
        },
        {
            ...
            name: 'DUMB DUMB',
            singer: 'SOMI',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUODUZD6/320'
        },
        {
            ...
            name: 'Em Sẽ Chờ',
            singer: 'Thảo Wendy',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOZ08U6/320'
        },
        {
            ...
            singer: 'Kidz',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0I6CBE/320'
        },
        {
            ...
            singer: 'Thảo Wendy',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWDO97F/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUZWU7F/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW8IEZU/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0BBO78/320'
        },
        {
            ...
            singer: 'Đông Đặng',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU0ABUF/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUI7WC8C/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW8IOB0/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOIIW7U/320'
        },
        {
            ...
            name: 'Ngân Lang',
            singer: 'G5R Squad',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOF6C7FC/320'
        },
        {
            ...
            singer: 'Kidz',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOII870/320'
        },
        {
            ...
            singer: 'Thiên Tú',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUW66CB/320'
        },
        {
            ...
            name: 'Sài Gòn Ơi!',
            singer: 'Châu Khải Phong, ACV',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU0FEWA/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOEOOC6D/320'
        },
        {
            ...
            singer: 'Lê Bảo Bình',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU8FUIU/320'
        },
        {
            ...
            singer: 'Lưu Ánh Loan',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU68U7A/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOEOO9E/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUOEUE7D/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOEIUW0E/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUBD779/320'
        },
        {
            ...
            singer: 'JayKii',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZOFEO67A/320'
        },
        {
            ...
            singer: 'JayKii',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZU0C7A7B/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWDOF7I/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWAE9IF/320'
        },
        {
            ...
            name: 'Ước Mơ Của Mẹ',
            singer: 'Vương Long',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUWWUEU0/320'
        },
        {
            ...
            name: 'Chia Tay?',
            singer: 'Trung Tự',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUU0AFZZ/320'
        },
        {
            ...
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUUED866/320'
        },
        {
            ...
            singer: 'Thiên Tú',
            path: 'https://api.mp3.zing.vn/api/streaming/audio/ZUW90D8E/320'
        },
        {
        ...
        const htmls = this.songs.map((item, index) => {
            return `        
                <div data-index="${index}" class="song ${index === this.currentIndex ? 'active' : ''}">
                    ...
                    <div class="body">
                        <h3 class="title" title="${item.name} Single - Code: ${item.code}">${item.name}</h3>
                        <p class="author">Singer: ${item.singer}</p>
                    </div>
                    <div class="option">
                        <i class="more-icon fas fa-ellipsis-h"></i>
                    </div>
                </div>`;});
    ...
    handleEvents: function () {
        ...
        // XỬ LÝ CD QUAY / DỪNG KHI BÀI HÁT PLAY / PAUSE
        ...
        /* XỬ LÝ PHÓNG TO / THU NHỎ CD 
            - Lắng nghe sự kiện khi scroll trên document -> onscroll
            - documentElement -> Lấy ra Element thẻ HTML
            - cdWidth -> Độ rộng của CD hiện tại
        */
        ...
        // LẮNG NGHE SỰ KIỆN KHI CLICK VÀO NÚT PLAY / PAUSE
        ...
        // LẮNG NGHE SỰ KIỆN PLAY TRÊN AUDIO
        ...
        // LẮNG NGHE SỰ KIỆN PAUSE TRÊN AUDIO
        ...
        // LẮNG NGHE SỰ KIỆN VỚI NÚT RANDOM
        ...
        // LẮNG NGHE SỰ KIỆN VỚI NÚT REPEAT
        ...
        /* Bắt được tiến độ bài hát ở thanh progress khi play song
            - audio.currentTime: Lấy thời gian hiện tại của bài hát
            - audio.duration: lấy tổng thời gian của bài hát
        */
        audio.ontimeupdate = function () {
            // Vì mới vào audio.duration = NaN nên phải check
            ...
            $('#current-time').innerHTML = currentTimeMinutue + ":"
            + currentTimeSecond;
            ...
            if(durationTimeMinutue && durationTimeSecond){
                $('#duration-time').innerHTML = durationTimeMinutue + ":" 
                + durationTimeSecond;
            }

            if (audio.duration) {
                // Thanh tiến độ phải lấy theo %
        ...
        /* Xử lý tua nhạc khi kéo thanh progress 
            - onchange -> khi có sự thay đổi xảy ra
        */
        ...
        /* Xử lý next song khi audio ended 
            - onended -> Sự kiện khi audio kết thúc
        */
        ...
        /* Lắng nghe hành vi click vào playlist 
            - closest(): trả về element chính nó hoặc của cha chứa nó
        */
        playlist.onclick = function (e) {
            let songNode = e.target.closest('.song:not(.active)');
            let option = e.target.closest('.option');
            // Nhấn vào nút option của bài hát nào thì không được chuyển đến bài hát đó
            if (songNode || option) {
                // chắc chắn click vào song thì xử lý
                if (songNode) {
                    //_this.currentIndex = Number(songNode.getAttribute['data-index]);
                    // Hoặc (mục đích đặt data-index là để dùng dataset)
                    _this.currentIndex = Number(songNode.dataset.index);
                    _this.loadCurrentSong();
                    audio.play();
                }
                // chắc chắn click vào option thì xử lý
                if (option) {
                }
            }
        };
    ...
    playRandomSong: function () {
        ...
        } while (this.currentIndex === newIndex); // Không trùng với bài hát hiện tại
    ...
    /* Xử lý tự động scroll đến bài hát hiện tại
        - element.scrollIntoView() -> search GG để hiểu rõ
    */
    ...
    // HÀM XỬ LÝ ĐỂ LOAD LẠI OPTION (CỤ THỂ Ở ĐÂY LÀ NÚT Random và Repeat) CHO NGƯỜI DÙNG
    loadConfig: function () {
        this.isRandom = this.config.isRandom;
        this.isRepeat = this.config.isRepeat;
    },

    // LẤY BÀI HÁT HIỆN TẠI KHI ỨNG DỤNG ĐƯỢC TẢI
    ...
    */
    ...
    start: function () {
        // Load ra cấu hình từ config đã lưu vào ứng dụng người dùng
        this.loadConfig();
...
app.start();
var date = new Date();
$('#year').innerHTML = 'T' + date.getMonth() + '/' + date.getFullYear();